...
public class Culturales implements EventoHistorico{
    ...
    public Culturales(String location, String name, String description, Integer date) {
    ...
    public void setTrayectoriaExpansion(String trayectoria){
